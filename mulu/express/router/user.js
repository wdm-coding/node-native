...
const verifyClientCert = require('../utils/certMiddleware');
...
.get('/certLogin', verifyClientCert,userController.certLogin) // 证书登录接口
...
.delete('/delete/:id', verifyToken(),userController.deleteUser) // 删除用户
...
.get('/getRegionCert', userController.getRegionCert) // 轻量连接器登录
